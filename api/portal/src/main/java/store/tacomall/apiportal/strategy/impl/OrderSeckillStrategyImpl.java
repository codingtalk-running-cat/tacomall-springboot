/***
 * @Author: 码上talk|RC
 * @Date: 2020-12-22 16:03:16
 * @LastEditTime: 2020-12-23 18:44:50
 * @LastEditors: 码上talk|RC
 * @Description: 
 * @FilePath: /tacomall-springboot/api/portal/src/main/java/store/tacomall/apiportal/strategy/impl/OrderSeckillStrategyImpl.java
 * @微信:  13680065830
...
public class OrderSeckillStrategyImpl implements OrderStrategy {
    ...
    public ResponseVo<List<Order>> genOrder(JSONObject json) {
        ...
        GoodsItem g = seckillGoodsItemApplyMapper.getSeckillGoodsItemApply(new QueryWrapper<SeckillGoodsItemApply>()
                .lambda().eq(SeckillGoodsItemApply::getId, json.getInteger("id"))).getGoodsItem();
        ...
        fromType2OrderValueBo.setQuantity(QUANTIRY_BUY_ONE);
        ...
        seckillGoodsItemApplyMapper.getSeckillGoodsItemApply(new QueryWrapper<SeckillGoodsItemApply>().lambda()
                .eq(SeckillGoodsItemApply::getId, json.getInteger("id"))).getGoodsItem();
