 ...
 * @LastEditTime: 2020-12-10 18:18:28
...
import store.tacomall.common.mapper.seckill.SeckillMapper;
...
public class SeckillServiceImpl extends ServiceImpl<SeckillMapper, Seckill> implements SeckillService {
    ...
    public ResponseVo<Map<String, Object>> info() {
        ...
        list = seckillGoodsItemApplyMapper.getSeckillGoodsItemApplys(new QueryWrapper<SeckillGoodsItemApply>().lambda()
                .eq(SeckillGoodsItemApply::getSeckillId, seckill.getId()));
