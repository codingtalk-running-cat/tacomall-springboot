 ...
 * @Description: 
 * @FilePath: /tacomall-springboot/tacomall-api/tacomall-api-merchant/src/main/java/store/tacomall/apimerchant/aspect/LoginLoggerAspect.java
 * @Just do what I think it is right
 */
package store.tacomall.apimerchant.aspect;
...
import store.tacomall.common.entity.merchant.MerchantUserLoginLogger;
import store.tacomall.common.mapper.merchant.MerchantUserLoginLoggerMapper;
...
public class LoginLoggerAspect {
    ...
    @Pointcut("@annotation(store.tacomall.apimerchant.annotation.LoginLogger)")
