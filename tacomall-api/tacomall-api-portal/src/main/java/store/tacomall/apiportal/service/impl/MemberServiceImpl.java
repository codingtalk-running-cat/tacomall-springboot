 ...
 * @LastEditTime: 2020-10-30 15:12:29
...
import store.tacomall.mapper.member.MemberMapper;
import store.tacomall.entity.member.MemberWeixin;
import store.tacomall.mapper.member.MemberWeixinMapper;
import store.tacomall.entity.member.MemberWeixinMa;
import store.tacomall.mapper.member.MemberWeixinMaMapper;
import store.tacomall.entity.member.MemberStatisticsInfo;
import store.tacomall.mapper.member.MemberStatisticsInfoMapper;
...
public class MemberServiceImpl extends ServiceImpl<MemberMapper, Member> implements MemberService {
    ...
    public ResponseVo<String> wxMaLogin(String appid, JSONObject json) throws Exception {
        ...
        Member member = baseMapper.getMember(new QueryWrapper<Member>().lambda().inSql(Member::getId,
                String.format("select id from member_weixin_ma where open_id = '%s'", session.getOpenid())));
